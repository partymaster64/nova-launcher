        ...
        <div class="wiz-progress">
          <div class="wiz-logo-wrap">
            <svg viewBox="0 0 100 100" width="80" height="80" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="mp-sg" x1="0" y1="0" x2="1" y2="1">
              ...
              <g class="wiz-star">
                <path class="wp wpn" d="M50,50 Q40,40 50,7  Q60,40 50,50Z" fill="url(#mp-sg)"/>
                <path class="wp wpe" d="M50,50 Q60,40 93,50 Q60,60 50,50Z" fill="url(#mp-sg)"/>
                <path class="wp wps" d="M50,50 Q60,60 50,93 Q40,60 50,50Z" fill="url(#mp-sg)"/>
                <path class="wp wpw" d="M50,50 Q40,60 7,50  Q40,40 50,50Z" fill="url(#mp-sg)"/>
